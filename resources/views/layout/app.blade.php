...
<head>
    ...
    <meta name="description" content="Shrisharada Dye and ENT Hospital offers advanced ENT care, specialized dye treatments, and comprehensive healthcare services. Trust our expert team for top-notch ear, nose, throat, and skin care. Contact us today!">
    <meta name="keywords" content="ENT hospital, dye treatments, Shrisharada, ear care, nose care, throat care, skin care, ENT specialist, dye and ENT hospital, advanced ENT care, ENT services, dye and skin treatments">
...
<header class="main-header header-style-one">
        ...
        <div class="container">
            <div class="outer-box clearfix">
                ...
                <div class="header-left clearfix pull-left">
                    <div class="logo">
                        <a href="index.html"><img src="{{url('public/assets/images/resources/logoo.jpg')}}" alt="Shrisharada Hospital" title=""></a>
                    </div>
                </div>
                <!--End Header Left-->
                <!--Start Header Right-->
        ...
        <div class="container">
            <div class="clearfix">
                ...
                <div class="logo float-left">
                    <a href="index.html" class="img-responsive"><img src="{{url('public/assets/images/resources/logoo.jpg')}}" alt="" title=""></a>
                </div>
                <!--Right Col-->
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="index.html"><img src="{{url('public/assets/images/resources/mobilemenu-logo.png')}}" alt="" title=""></a></div>
                    ...
                    <div class="single-footer-widget marbtm">
                        <div class="our-company-info">
                            <div class="footer-logo">
                                <a href="index.html"><img src="{{url('public/assets/images/footer/footer-logo.png')}}" alt="Awesome Footer Logo" title="Logo"></a>    
                            </div>
                            <div class="text">
                        ...
                        <ul class="footer-news-links clearfix">
                            <li class="single-news">
                                <div class="img-holder">
                                    <img src="{{url('public/assets/images/footer/footer-news-1.jpg')}}" alt="Awesome Image">
                            ...
                            <li class="single-news">
                                <div class="img-holder">
                                    <img src="{{url('public/assets/images/footer/footer-news-2.jpg')}}" alt="Awesome Image">
                                    <div class="overlay-content">
                                        <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="outer-box">
                <div class="copyright-text text-center">
                    <p>&copy; Copyright 2020 by <a href="#">Shrisharada</a></p>
                </div>
            </div>    
        </div>    
    </div>
